...
const Achievements = () => {
  return (
    <div data-aos="fade-up">
        ...
        <div className="lg:text-5xl text-4xl text-center mt-10 font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-pink-600">
        ...
        <div className="lg:px-52 px-8 mt-8 text-justify">
            ...
            Chairman of the Student Representative Counsil <span className="text-white">(2022-2023)</span>
            </h1>
            <p className="mt-2 text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-50">
            As the Chairman of the Student Representative Council (MPK), my main duties involve steering and overseeing the council to ensure strong student representation and effective governance.
            </p>
        </div>
        
        <div className="lg:px-52 px-8 mt-8 text-justify">
            <h1 className="font-bold lg:text-3xl text-xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 ">
            Class Leadership Streak: 12 Years in a Row <span className="text-white">(2011-2023)</span>
            </h1>
            <p className="mt-2 text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-50">
            For 12 consecutive years, I had the privilege of serving as the class leader, a role that allowed me to continuously contribute to and influence the dynamics of our classroom environment. t was a journey of consistent leadership, responsibility, and commitment, where I developed strong organizational and communication skills and built lasting relationships with peers and educators.
            </p>
        </div>
